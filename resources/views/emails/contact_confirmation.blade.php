...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@300;400&family=Montserrat:wght@300;400&display=swap"
        rel="stylesheet">
    <style>
        body {
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <p><strong>The Yunara Team</strong><br>
                {{-- <em>Omotenashi in Every Detail</em> --}}
            </p>
        </div>
        <div class="footer">
